...
from epicsQt import eLabel

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")


class eLabelPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eLabelTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eLabel" name=\"eLabel\" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "epicsQt/eLabel"


class eLabelTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eLabel):
            return eLabelTaskMenu(obj, parent)

        return None


class eLabelTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
