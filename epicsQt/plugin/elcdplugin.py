...
from epicsQt import eLCD

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")


class eLCDPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eLCDTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eLCD" name=\"eLCD\" />\n'
...
class eLCDTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eLCD):
            return eLCDTaskMenu(obj, parent)

        return None


class eLCDTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
