...
from epicsQt import eCheckBox

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")


class eCheckBoxPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eCheckBoxTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eCheckBox" name=\"eCheckBox\" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "epicsQt/eCheckBox"


class eCheckBoxTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eCheckBox):
            return eCheckBoxTaskMenu(obj, parent)

        return None


class eCheckBoxTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
