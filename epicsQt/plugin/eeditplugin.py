...
from epicsQt import eEdit

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")


class eEditPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eEditTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eEdit" name=\"eEdit\" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "epicsQt/eEdit"


class eEditTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eEdit):
            return eEditTaskMenu(obj, parent)

        return None


class eEditTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
