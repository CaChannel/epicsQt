...
from epicsQt import eDoubleSpin

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")


class eDoubleSpinPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eDoubleSpinTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eDoubleSpin" name=\"eDoubleSpin\" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "epicsQt/eDoubleSpin"


class eDoubleSpinTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eDoubleSpin):
            return eDoubleSpinTaskMenu(obj, parent)

        return None


class eDoubleSpinTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
