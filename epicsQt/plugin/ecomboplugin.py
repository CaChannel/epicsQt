...
from epicsQt import eCombo

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")


class eComboPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eComboTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eCombo" name=\"eCombo\" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "epicsQt/eCombo"


class eComboTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eCombo):
            return eComboTaskMenu(obj, parent)

        return None


class eComboTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
