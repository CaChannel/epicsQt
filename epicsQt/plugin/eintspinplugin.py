...
from epicsQt import eIntSpin

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")


class eIntSpinPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eIntSpinTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eIntSpin" name=\"eIntSpin\" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "epicsQt/eIntSpin"


class eIntSpinTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eIntSpin):
            return eIntSpinTaskMenu(obj, parent)

        return None


class eIntSpinTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
