...
from epicsQt import eTextEdit

def Q_TYPEID(class_name):
    return QtCore.QString("com.trolltech.Qt.Designer.TaskMenu")
print "dfvdf"

class eTextEditPlugin(QtDesigner.QPyDesignerCustomWidgetPlugin):
    ...
    def initialize(self, formEditor):
        ...
        if manager:
            self.factory = eTextEditTaskMenuFactory(manager)
    ...
    def domXml(self):
        return '<widget class="eTextEdit" name=\"eTextEdit\" />\n'

    # Returns the module containing the custom widget class. It may include
    # a module path.
    def includeFile(self):
        return "epicsQt/eTextEdit"


class eTextEditTaskMenuFactory(QtDesigner.QExtensionFactory):
    def __init__(self, parent = None):
    ...
    def createExtension(self, obj, iid, parent):
        ...
        # modified.
        if isinstance(obj, eTextEdit):
            return eTextEditTaskMenu(obj, parent)

        return None


class eTextEditTaskMenu(QtDesigner.QPyDesignerTaskMenuExtension):
